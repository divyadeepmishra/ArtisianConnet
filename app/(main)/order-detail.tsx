...
export default function OrderDetailScreen() {
  ...
  }, [orderId]); // removed getToken to avoid unnecessary re-renders
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.actionSection}>
          ...
          <TouchableOpacity style={[styles.actionButton, styles.secondaryButton]}>
            ...
            <Text style={[styles.actionButtonText, styles.secondaryButtonText]}>Cancel Order</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailValue}>₹{(Number(order.total_amount) + 50).toFixed(2)}</Text>
          </View>
          <View style={styles.detailRow}>
...
const styles = StyleSheet.create({
  ...
  productImage: {
    width: '100%', height: 300, borderRadius: 16, marginBottom: 16, backgroundColor: '#E5E7EB'
  },
  card: {
    backgroundColor: 'white', borderRadius: 12, padding: 16, marginBottom: 16,
  },
  cardTitle: {
    fontSize: 18, fontWeight: 'bold', marginBottom: 12, color: '#111827'
  },
  actionSection: {
    flexDirection: 'row', justifyContent: 'space-between', marginBottom: 16, gap: 16,
  },
  actionButton: {
